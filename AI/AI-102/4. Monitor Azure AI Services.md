...
Here's an example of Diagnostic Settings enabling Log Analytics and Azure Storage: ![Diagnostic settings example configuration](./Images/4-diagnostic-settings.png)

### Viewing Logs in Azure Log Analytics
It can take an hour or more for data to being showing in your destinations.

When the data begins to show, you can view it in the Log Analytics resource by running queries like shown here: ![Log Analytics query example](./Images/4-azure-log-analytics.png)
